...
sealed class CalendarEvent {
    ...
    data class SaveCurrentRoute(val route: String): CalendarEvent()

    data class AddFood(val route: String): CalendarEvent()
   // data class DeleteWorkOut(val workout: WorkoutListItem): CalendarEvent()

    data class OpenDialogWorkout(val workout: WorkoutListItem, val dialog: String, val title: String): CalendarEvent()
    data class OpenDialogFood(val food: CalculationCalorieItem, val dialog: String, val title: String): CalendarEvent()
