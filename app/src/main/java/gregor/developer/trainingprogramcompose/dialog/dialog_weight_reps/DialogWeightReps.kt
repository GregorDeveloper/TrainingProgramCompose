            ...
            Card(
                ...
                Column(
                    ...
                    TextField(
                        ...
                        onValueChange = { reps ->
                            dialogController.onDialogEvent(
                                DialogWeightRepsEvent.OnTextChangeReps(
                                    reps
                                )
                            )
                        },
                    ...
                    Row(
                        ...
                        Button(
                            onClick = { dialogController.onDialogEvent(DialogWeightRepsEvent.OnCancel) },
                        ...
                        Button(
                            onClick = { dialogController.onDialogEvent(DialogWeightRepsEvent.OnConfirm) },
                            modifier = Modifier.weight(1f)
                        ) {
